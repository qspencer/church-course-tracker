...
# Development Deployment Setup for apps.eastgate.church
set -e
...
if ! command -v docker &> /dev/null; then
    echo "❌ Docker not found. Please run: sudo ./scripts/install-prerequisites.sh"
    exit 1
fi
...
echo "2. Run: ./scripts/deploy-dev-application.sh"
