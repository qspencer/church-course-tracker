...
!!! info "Feature Overview"
    This page describes all the capabilities of Church Course Tracker. For step-by-step instructions on how to use these features, see the [User Guide](user-guide.md).
...
!!! success "Core Feature"
    Create, organize, and manage educational courses for your church.
...
2. Review the [Getting Started Guide](getting-started.md) for basics
