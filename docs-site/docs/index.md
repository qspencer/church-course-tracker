...
- **[Getting Started Guide](getting-started.md)** - New to the system? Start here to learn the basics
...
- If you're **new to the system**, start with the [Getting Started Guide](getting-started.md)
- If you want to **learn about specific features**, check the [Features Overview](features.md)
- If you need **detailed instructions** on how to use the system, read the [User Guide](user-guide.md)
