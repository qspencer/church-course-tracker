...
class People(Base):
    ...
    people_campus = relationship(
        "PeopleCampus", back_populates="people", cascade="all, delete-orphan"
    )
    people_role = relationship(
        "PeopleRole", back_populates="people", cascade="all, delete-orphan"
    )
    course_role = relationship(
        "CourseRole", back_populates="people", cascade="all, delete-orphan"
    )
