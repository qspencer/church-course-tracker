...
class ContentCompletion(Base):
    ...
    course_enrollment_id = Column(
        Integer, ForeignKey("course_enrollment.id"), nullable=False, index=True
    )
    ...
    # Relationships
    course_enrollment = relationship(
        "CourseEnrollment", back_populates="content_completion"
    )
