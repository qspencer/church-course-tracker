...
from app.models.course_content import (ContentType, CourseContent,
                                       CourseModule, StorageType)
    ...
    def _load_people(self, db: Session, force_reload: bool = False) -> int:
        ...
        with open(csv_file, "r", encoding="utf-8") as file:
            ...
            for row in reader:
                ...
                campus = (
                    db.query(Campus)
                    .filter(Campus.name == row.get("campus", ""))
                    .first()
                )
    ...
    def _load_modules(self, db: Session, force_reload: bool = False) -> int:
        ...
        with open(csv_file, "r", encoding="utf-8") as file:
            ...
            for row in reader:
                # Get course by title
                course = (
                    db.query(Course).filter(Course.title == row["course_title"]).first()
                )
                if not course:
        ...
        with open(csv_file, "r", encoding="utf-8") as file:
            ...
            for row in reader:
                ...
                if not course or not person:
                    logger.warning(
                        f"Course or person not found: {row['course_title']}, {row['first_name']} {row['last_name']}"
                    )
                    continue
...
def create_sample_csv_files(data_dir: str = "data/csv"):
    ...
    # Create campuses CSV
    with open(
        os.path.join(data_dir, "campuses.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        ...
        writer.writerow(
            [
                "Main Campus",
                "123 Church St, Anytown, CA 12345",
                "555-1234",
                "main@church.com",
                "true",
            ]
        ...
        writer.writerow(
            [
                "North Campus",
                "456 North Ave, Anytown, CA 12346",
                "555-5678",
                "north@church.com",
                "true",
            ]
        ...
        writer.writerow(
            [
                "South Campus",
                "789 South Blvd, Anytown, CA 12347",
                "555-9012",
                "south@church.com",
                "true",
            ]
    ...
    # Create roles CSV
    with open(
        os.path.join(data_dir, "roles.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        writer = csv.writer(file)
        writer.writerow(["name", "description", "permissions", "is_active"])
        writer.writerow(["admin", "System Administrator", "all", "true"])
        writer.writerow(
            ["staff", "Church Staff", "manage_courses,manage_users", "true"]
        )
    ...
    # Create people CSV
    with open(
        os.path.join(data_dir, "people.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        writer = csv.writer(file)
        writer.writerow(
            [
    ...
    # Create courses CSV
    with open(
        os.path.join(data_dir, "courses.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        writer = csv.writer(file)
        writer.writerow(
        ...
        writer.writerow(
            [
                ...
                "A foundational course on Christian faith and beliefs",
                "6",
                "30",
                "true",
            ]
        ...
        writer.writerow(
            [
                "Bible Study Methods",
                "Learn how to study and interpret the Bible effectively",
                "8",
                "25",
                "true",
            ]
        ...
        writer.writerow(
            [
                "Church History",
                "Explore the history of Christianity and the church",
                "10",
                "20",
                "true",
            ]
        ...
        writer.writerow(
            [
                "Christian Ethics",
                "Understanding moral principles from a Christian perspective",
                "6",
                "25",
                "true",
            ]
        ...
        writer.writerow(
            [
                "Worship and Music",
                "The role of music and worship in Christian life",
                "4",
                "15",
                "true",
            ]
    ...
    # Create modules CSV
    with open(
        os.path.join(data_dir, "modules.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        writer = csv.writer(file)
        writer.writerow(
        ...
        writer.writerow(
            [
                "Introduction to Faith",
                "What is Faith?",
                "Understanding the concept of faith in Christianity",
                "1",
                "true",
            ]
        )
        writer.writerow(
            [
                "Introduction to Faith",
                "The Trinity",
                "Exploring the Father, Son, and Holy Spirit",
                "2",
                "true",
            ]
        )
        writer.writerow(
            [
                "Introduction to Faith",
                "Salvation",
                "Understanding salvation and grace",
                "3",
                "true",
            ]
        )
        writer.writerow(
            [
                "Bible Study Methods",
                "Reading the Bible",
                "How to read and understand biblical texts",
                "1",
                "true",
            ]
        )
        writer.writerow(
            [
                "Bible Study Methods",
                "Interpretation",
                "Methods for interpreting scripture",
                "2",
                "true",
            ]
        )
    ...
    # Create content CSV
    with open(
        os.path.join(data_dir, "content.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        writer = csv.writer(file)
        writer.writerow(
            [
        ...
        writer.writerow(
            [
                "Introduction to Faith",
                "What is Faith?",
                "Faith Definition Video",
                "A video explaining the definition of faith",
                "video",
                "database",
                "1",
                "true",
        ...
        writer.writerow(
            [
                ...
                "What is Faith?",
                "Faith Study Guide",
                "A comprehensive study guide on faith",
                "document",
                "database",
                "2",
                "true",
        ...
        writer.writerow(
            [
                "Introduction to Faith",
                "The Trinity",
                "Trinity Audio Lesson",
                "An audio lesson on the Trinity",
                "audio",
                "database",
                "2",
                "true",
        ...
        writer.writerow(
            [
                ...
                "Reading the Bible",
                "Bible Reading Guide",
                "A guide to effective Bible reading",
                "document",
                "database",
                "1",
                "true",
        ...
        writer.writerow(
            [
                ...
                "Reading the Bible",
                "Bible Study Video",
                "Video tutorial on Bible study methods",
                "video",
                "database",
                "2",
                "true",
    ...
    with open(
        os.path.join(data_dir, "enrollments.csv"), "w", newline="", encoding="utf-8"
    ) as file:
        writer = csv.writer(file)
        writer.writerow(
