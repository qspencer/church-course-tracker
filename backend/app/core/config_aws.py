"""
AWS Production Configuration for Church Course Tracker
"""
...
class AWSSettings(BaseSettings):
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://postgres:password@localhost:5432/church_course_tracker")
